...
`sessions/-work-harvey-freepeak/2026-09-08T06-48-35-469Z_….jsonl`.)*
...
- **Session JSONL tool-result entry** (real, `sessions/-work-harvey-freepeak/2026-09-08T06-48-35…jsonl`):
